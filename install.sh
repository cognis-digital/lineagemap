#!/usr/bin/env sh
# Universal installer for lineagemap. Prefers uv > pipx > pip; installs from the repo.
set -e
SRC="git+https://github.com/cognis-digital/lineagemap.git"
echo "Installing lineagemap ..."
