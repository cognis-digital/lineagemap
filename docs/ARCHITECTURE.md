...
- **rules/analyzers** apply the heuristics shipped in `lineagemap/core.py`.
- **score** ranks by severity.
- **MCP server** (`lineagemap mcp`) exposes `scan` for Cognis.Studio agents.
