"""LINEAGEMAP core — Column-level lineage extracted from SQL and dbt."""
...
RULES = [
    ("LIN-001", "high", "TODO", "Unresolved TODO / placeholder left in input", "Resolve before shipping."),
    ("LIN-002", "medium", "FIXME", "FIXME marker found", "Address the flagged issue."),
    ("LIN-003", "low", "XXX", "XXX marker found", "Review the flagged section."),
]
